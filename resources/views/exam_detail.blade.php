                                ...
                                <ul class="list-group">
                                    @foreach ($exam->topTen as $tUsers)
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <img class="w-8 h-8 rounded-full" src="{{ $tUsers->top_users->profile_photo_url }}">
                                            <span @if (auth()->user()->id==$tUsers->user_id) class="text-success" @endif >{{ $tUsers->top_users->name }}</span>
